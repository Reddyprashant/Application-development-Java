 ...
 */
public class NGOViewDetailsJPanel extends javax.swing.JPanel {
    ...
    private NGORequestAreaJPanel ngoRequestPanel;

    public NGOViewDetailsJPanel(JPanel userProcessContainer, UserAccount account, NGOOrganization organization, Enterprise enterprise, StateNetwork network, CountryNetwork cNetwork, EcoSystem business, BeneficiaryWorkRequest p) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(lblWarning, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 560, -1, -1));
    ...
    private void UpdateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateBtnActionPerformed
        ...
        try {
            ...
            if (!availVolTextField.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "Please Add Available volunteers");
            }
